 ...
 ******************************************************************************/
#define progress_sx (screen_width2 - screen_width / 3) // From the center -160 / -80
#define progress_ex (screen_width2 + screen_width / 3) // + 160 / + 80 from the center
#define progress_sy (screen_height2 + 3)               // +3 from the center
#define progress_ey (screen_height2 + 13)              // +13 from the center
#define yesno_sx (screen_width2 - screen_width / 3)    // From the center -160 / -80
#define yesno_ex (screen_width2 + screen_width / 3)    // + 160 / + 80 from the center
#define yesno_sy (screen_height2 + 3)                  // +3 from the center
#define yesno_ey (screen_height2 + 13)                 // +13 from the center
