...
// VRAM memory map(Mange everything yourself without using the VRAM allocation API)
// 0x000000～0x0BFFFF(0xC0000 768.0kb) Display framebuffer
// 0x0C0000～0x0D2DFF(0x12E00  75.5kb) Framebuffer for GBA 1
// 0x0D2E00～0x0E5BFF(0x12E00  75.5kb) Framebuffer for GBA 2
// 0x0E5C00～0x125BFF(0x40000 256.0kb) Framebuffer for MENU 1
// 0x125C00～0x165BFF(0x40000 256.0kb) Framebuffer for MENU 2
// 0x165C00～0x1A5BFF(0x40000 256.0kb) Skin buffer for MENU(For future use)
// 0x1A5C00～0x1FBFFF(0x56400 345.0kb) General purpose data buffer
// 0x1FC000～0x1FC0FF(0x00100 256byte) GU command buffer for framebuffer transfer
// 0x1FC100～0x1FC1FF(0x00100 256byte) Vertex data buffer for framebuffer transfer
// 0x1FC200～0x1FFFFF(0x03E00  15.5kb) General-purpose vertex data buffer
...
#define GBA_BUFFER_SIZE (240 * 161 * 2)  /* Secure one more line for interlacing */
#define MENU_BUFFER_SIZE (480 * 273 * 2) /* Secure one more line for interlacing */
...
void init_video()
{
    ...
    // Make the palette 5551 (0BBBBBGGGGGRRRRR) GBA is also 0BBBBBGGGGRRRRR so no conversion is needed
