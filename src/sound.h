...
/******************************************************************************
 * Definition of macros and enums
 ******************************************************************************/
enum DIRECT_SOUND_STATUS_TYPE
{
...
enum DIRECT_SOUND_VOLUME_TYPE
{
    DIRECT_SOUND_VOLUME_50,
    DIRECT_SOUND_VOLUME_100
};

enum GBC_SOUND_STATUS_TYPE
{
    GBC_SOUND_INACTIVE,
    GBC_SOUND_RIGHT,
    GBC_SOUND_LEFT,
...
#define BUFFER_SIZE (0xffff) // The number of bytes in the buffer. Do not change
