...
// Remove unnecessary parts for gpSP (32bit mode, etc.)
...
/*------------------------------------------------------
Calculate the width of the character string
   str: Draw String
   RET: Draw Width
------------------------------------------------------*/
...
/*------------------------------------------------------
  Write a string to the specified framebuffer
